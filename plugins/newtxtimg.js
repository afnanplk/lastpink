        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/thunder.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/thunder.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/123g.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/123g.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/berry.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/berry.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/li.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/peridot.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/honey.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/honey.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/greenhorror.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/greenhorror.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/3dneon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/3dneon.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/metalgalaxy.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/metalgalaxy.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/metalsilver.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/metalsilver.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/rosegold.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/rosegold.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${match[1]}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/transformer.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/transformer.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/luxurymetel.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/luxurymetel.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/mtg.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/mtg.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/capamarica.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/capamarica.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/magma.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/magma.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/layered.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/layered.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/embossed.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/embossed.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/papercut.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/papercut.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/wonderfullgraf.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/wonderfullgraf.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/criholy.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/criholy.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    jessisapi.textpro("https://textpro.me/create-realistic-cloud-text-effect-online-free-999.html",
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/reacloud.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/reacloud.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    jessisapi.textpro("https://textpro.me/write-text-on-foggy-window-online-free-1015.html",
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/catwindow.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/catwindow.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/scc.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/scc.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/halloween.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/halloween.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/glue.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/glue.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/sci.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/sci.jpg'), MessageType.image, { caption: Config.AFN})
              })
          } catch(err) { 
              console.log(err)
          } 
