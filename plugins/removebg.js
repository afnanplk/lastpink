...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'removebg ?(.*)', fromMe: false, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
        ...
        await message.client.sendMessage(message.jid,fs.readFileSync('rbg.png'), MessageType.document, {filename: Config.AFN, mimetype: Mimetype.png, quoted: message.data});
        await load.delete();
    }));
