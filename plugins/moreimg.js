...
Asena.addCommand({pattern: 'break ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
 ...
 Asena.addCommand({pattern: 'emo ?(.*)', fromMe: false, desc: 'emogi to png'}, (async (message, match) => {
      ...
      await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), {quoted: message.data , mimetype: Mimetype.png,contextInfo: { forwardingScore: 1000, isForwarded: true}, caption: Config.AFN})
    ...
    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.video, {quoted: message.data , mimetype: Mimetype.mp4,contextInfo: { forwardingScore: 1000, isForwarded: true}, caption: Config.AFN})
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.zeks.me/api/pubglogo?apikey=cjxJIn9eDletRHac3CG6CdvGxFH&text1=${topText}&text2=${bottomText}`, { responseType: 'arraybuffer' })
