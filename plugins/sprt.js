...
r_text[1] = "zaraye tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Zara Mwol says i love you 😘";
r_text[3] = "Zara Mwoludeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Zara Mwol - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Zara Mwol ,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[13] = ".song adich thangalude fav song name para Zara Mwol ath download aakki theraam";
...
r_text[18] = "enikk njan und Zara Mwol uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Zara Mwol pazhaya Zara Mwol thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Zara Mwolik";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Zara Mwol";
...
Asena.addCommand({pattern: 'zara', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
    ...
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Zara Mwole tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Zara Mwol says i love you 😘";
r_text[3] = "Zara Mwoludeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
...
await message.sendMessage(r_text[i]), {contextInfo: { forwardingScore: 1000, isForwarded: true }, quoted: message.data};
