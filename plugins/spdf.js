...
if (Config.WORKTYPE == 'private') {
  ...
  Raashii.addCommand({ pattern: 'spdf ?(.*)', fromMe: true, desc: 'Get screenshot of links in pdf'}, (async (message, match) => {
    ...
    await message.client.sendMessage(Buffer.from(rashi.data), MessageType.document, { filename: 'raashii.pdf', mimetype: Mimetype.pdf});
  ...
  Raashii.addCommand({ pattern: 'spdf ?(.*)', fromMe: false, desc: 'Get screenshot of links in pdf'}, (async (message, match) => {
    ...
    await message.client.sendMessage(Buffer.from(rashi.data), MessageType.document, {filename: 'sspdf.pdf', mimetype: Mimetype.pdf});
