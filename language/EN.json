{
    ...
    "STRINGS": {
        ...
        "admin": {
            ...
            "IM_NOT_ADMIN": "ꜱᴏʀʀʏ ᴀᴍ ɴᴏᴛ ᴀᴅᴍɪɴ",
            "BANNED": "ʀᴇᴍᴏᴠᴇᴅ ꜰʀᴏᴍ ɢʀᴏᴜᴘ",
            "GIVE_ME_USER": "ɢɪᴠᴇ ᴍᴇ ᴀ ᴜꜱᴇʀ",
            "ADD_DESC": "Adds someone to the group.",
            "ADDED": "ᴀᴅᴅᴇᴅ ᴛᴏ ᴛʜᴇ ɢʀᴏᴜᴘ",
            "ALREADY_PROMOTED": "ʜᴇ ɪꜱ ᴀʟʀᴇᴀᴅʏ ᴀᴅᴍɪɴ ᴏᴏᴘᴢ",
            "PROMOTED": ", ᴄᴏɴɢʀᴀᴛᴢ ʏᴏᴜ ᴀʀᴇ ᴘʀᴏᴍᴏᴛᴇᴅ",
        ...
        "heroku": {
            "RESTART_DESC": "Restart pinky",
            "RESTART_MSG": "ʀᴇꜱᴛᴀʀᴛɪɴɢ ᴘɪɴᴋʏ",
            "SHUTDOWN_DESC": "Shutdown pinky",
        ...
        "removebg": {
            ...
            "RBGING": "```background maayich thera ijj wait aak...```"
        },
        "scrapers": {
            ...
            "SING_DESC": "Sings the song you wrote.",
            "NEED_TEXT_SONG": "ᴘʟᴇᴀꜱᴇ ᴡʀɪᴛᴇ ᴀ ꜱᴏɴɢ \n ᴇxᴀᴍᴘʟᴇ:.ꜱᴏɴɢ ᴏᴘᴇɴ ʏᴏᴜʀ ᴡɪɴɢꜱ",
            "NEED_TEXT_SING": "*Tell me which song to sing !*\n*Example:* ```.sing open your wings```",
            "NO_RESULT": "*I couldn't find anything :(*",
            "DOWNLOADING_SONG": "ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ꜱᴏɴɢ",
            "DOWNLOADING_SING": "ɢᴇᴛ ʀᴇᴀᴅʏ ᴛᴏ ʜᴇᴀʀ ᴍᴇ ꜱɪɴɢ",
            "UPLOADING_SONG": "ᴜᴘʟᴏᴀᴅɪɴɢ ꜱᴏɴɢ",
            "UPLOADING_SING": " ᴀʀᴇ ʏᴏᴜ ʀᴇᴀᴅʏ ᴛᴏ ʜᴇᴀʀ ",
            "VIDEO_DESC": "Downloads video from YouTube.",
            "NEED_VIDEO": "*Please write a video link!*\n*Example:* ```.video https://www.youtube.com/watch?v=t1r_tmgQago```",
            "DOWNLOADING_VIDEO": "ᴡᴀɪᴛ ᴀᴍ ꜱᴇᴀʀᴄʜɪɴɢ",
            "UPLOADING_VIDEO": "ʜᴀʜᴀ ꜰᴏᴜɴᴅ ɪᴛ",
        ...
        "updater": {
            "UPDATER_DESC": "Checks the update for pinky.",
            "UPDATE": "*Your pinky is completely up-to-date!*",
            "NEW_UPDATE": "*New update available for pinky!*\n\n ```use .list for commands``` \n\n *ask support group before updating or your bot might stop working* \n *-if bot stop working you will have to re-deploy* \n\n Updates are:\n\n ",
            "UPDATE_NOW_DESC": "It makes updates.",
            "UPDATING": "Pinky Updating...",
            "INVALID_HEROKU": "*❌ Your Heroku information is wrong!*",
            "UPDATED": "*✅ Successfully Updated!*",
            "UPDATED_LOCAL": "*✅ Successfully Updated!*",
            "AFTER_UPDATE": "*💬 Pinky Restarting Automatically!*",
        ...
        "spammer": {
            ...
            "VİD_NEED": "ᴘʟᴇᴀꜱᴇ ʀᴇᴘʟʏ ᴛᴏ ᴀɴʏ ᴠɪᴅᴇᴏ!"
        },
        "carbon": {
        ...
        "scam": {
            ...
            "SCAM_NULL": "\n```Wrong Action Entered! Please use existing types.```\n"
        },
        "deepai": {
        ...
        "github": {
            ...
            "WIND": "Wind Speed",
            "CLOUD": "Cloud",
            "NOT_FOUND": "```ingane oru sthalam indo..? enthayallum enit kandethaan ayeela. 😖```",
        ...
        "lyrics": {
            "LY_DESC": "Pinky will find the lyrics of the song.",
            "NEED": "\n```You Must Write Any Song!```\n",
            "SLY": "Lyrics:",
            "AUT": "Song Owner:",
            "BUL": "Founded Song:",
            "ARAT": "Searched Song:"
